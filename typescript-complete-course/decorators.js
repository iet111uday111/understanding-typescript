...
var CourseDecorator = /** @class */ (function () {
    function CourseDecorator(name) {
        this.name = name;
    }
    CourseDecorator.prototype.printStudentNumbers = function (mode, printAll) {
        if (printAll) {
            console.log(10000);
        }
        else {
    ...
    __decorate([
        __param(1, printInfo)
    ], CourseDecorator.prototype, "printStudentNumbers", null);
    return CourseDecorator;
}());
var courseDecorator = new CourseDecorator("Super Course");
